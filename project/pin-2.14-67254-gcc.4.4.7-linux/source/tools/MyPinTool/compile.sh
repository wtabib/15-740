...
g++ simple_mem_access.cpp -o simple_mem_access.o;

PINEXEC=simple_pin_tool
rm ${PINEXEC}.so
...
/home/vittorio/Downloads/pin-2.14-67254-gcc.4.4.7-linux/pin -injection child -t ${PINEXEC}.so -- ./simple_mem_access.o
